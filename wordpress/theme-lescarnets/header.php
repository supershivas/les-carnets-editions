...
<header class="site-head wrap">
  ...
  <?php // Ouvert d'emblée sur une page de résultats : le champ porte la recherche en cours ?>
  <form class="head-search<?php echo (get_search_query() !== '') ? ' is-open' : ''; ?>"
    ...
    <button type="submit" class="hs-btn"
            aria-label="<?php echo lescarnets_txt_attr('recherche_label'); ?>"
            aria-expanded="<?php echo (get_search_query() !== '') ? 'true' : 'false'; ?>"
            aria-controls="head-s">
